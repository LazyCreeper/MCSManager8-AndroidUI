...
(function () {
	...
	TOOLS.encodeConsoleColor = function (text) {
		...
		text = text.replace(/INFO/gm, term.TERM_TEXT_GREEN + "信息" + term.TERM_NULL);
	...
	TOOLS.encodeConsoleColorForHtml = function (text) {
		...
		text = text.replace(/\]/igm, "<span style='color:#10e616;'>]</span>");
		text = text.replace(/INFO/gm, "<span style='color:#03ea0a;'>信息</span>");
		text = text.replace(/WARN/gm, "<span style='color:#ffd400;'>警告</span>");
		text = text.replace(/ERROR/gm, "<span style='color:#f44336;'>错误</span>");
